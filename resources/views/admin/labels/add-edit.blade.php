        ...
        <div class="col-12">
            ...
            <div class="card @if($pageTitle == 'Create') card-info @else card-warning @endif">
                <div class="card-header">
                    <h3 class="card-title">{{ $pageTitle ?? '' }} Label</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                            ...
                            <div
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" @class(["is-invalid" => $errors->has('status'), "form-control" => true])>
                                        <option {{ isSelected('status', ($label ?? null), '1')  }} value="1">Active</option>
                                        <option {{ isSelected('status', ($label ?? null), '0') }} value="0">Inactive</option>
                                    </select>
