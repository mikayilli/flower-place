        ...
        <div class="col-12">
            ...
            <div class="card @if($pageTitle == 'Create') card-info @else card-warning @endif">
                <div class="card-header">
                    <h3 class="card-title">{{ $pageTitle ?? '' }} Color</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div
                                ...
                                <div class="form-group">
                                    <label for="exampleInputName1">Code<span class="text-danger">*</span></label>
                                    <input type="color"
                                           @class(["is-invalid" => $errors->has('name'), "form-control" => true]) name="code"
                                           id="exampleInputName1" placeholder="Code" required
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" @class(["is-invalid" => $errors->has('status'), "form-control" => true])>
                                        <option {{ isSelected('status', ($color ?? null), '1')  }} value="1">Active</option>
                                        <option {{ isSelected('status', ($color ?? null), '0') }} value="0">Inactive</option>
                                    </select>
